                    ...
                    <div className="fiche">
                        <div className="fiche_contenu">
                            <Row>
                                ...
                                <Col>
                                    <span className="info_nom">Je m'appelle Laila</span><br/><span className="info_age"> j'ai 22 ans et je suis en formation Développement web au Samsung Campus.</span>
